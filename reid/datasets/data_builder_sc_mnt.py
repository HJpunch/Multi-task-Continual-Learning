...
class DataBuilder_sc(object):
    ...
    def _build_train_loader(self, dataset):
        ...
        init_loader = DataLoader(PreProcessor(dataset, root=data_root,
    ...
    def _build_test_loader(self, query_dataset, gallery_dataset):
        ...
        data_root = self.this_task_info.root_path if self.this_task_info else self.args.root
        print(f"data root test loader: {data_root}")
    ...
    def build_data(self, is_train, image_list=None):
        ...
        if is_train:
            ...
            train_loader, init_loader = self._build_train_loader(train_dataset.data)
            return train_loader, init_loader, train_dataset
